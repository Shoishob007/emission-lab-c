      ...
      <div className="max-w-6xl mx-auto px-3">
        ...
        <div className="grid md:grid-cols-[720px_1fr] gap-8 md:gap-16 mb-16 items-center">
          ...
          <div className="relative">
            <img
              src="https://res.cloudinary.com/dmazsiqdy/image/upload/f_auto,q_auto:good,w_1200/v1752140066/emisison-lab/2150196705_fpw74u.jpg"
              alt="Business API"
        ...
        <div className="grid md:grid-cols-[1fr_720px] gap-8 md:gap-16 mb-16 items-center">
          <div className="relative order-2 md:order-1">
            <img
              src="https://res.cloudinary.com/dmazsiqdy/image/upload/f_auto,q_auto:good,w_1200/v1752139948/emisison-lab/2151908117_nzjw8u.jpg"
              alt="Travel API"
