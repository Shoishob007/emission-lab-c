        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <div className="flex items-center justify-center gap-4 mt-6">
              <Badge className="bg-green-100 text-green-700 px-4 py-2 text-base font-medium hover:bg-none">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div className="text-center p-4 bg-green-50 rounded-lg">
                  ...
                  {carbonOffset?.enabled && (
                    <div className="text-sm text-gray-600">
                      {carbonOffset.totalEmission} Metric Tons CO₂e
                    </div>
                  )}
                </div>
              </div>
                ...
                {nextSteps.map((step, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <div
                          className={`w-6 h-6 bg-${step.color}-500 rounded-full flex items-center justify-center text-white text-xs font-bold`}
                        >
                          {step.step}
                        </div>
                      </div>
