        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            <div className="relative mb-6">
              ...
              <div className="absolute -bottom-2 -left-2 w-6 h-6 bg-yellow-400 rounded-full animate-ping"></div>
            </div>
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Your flight has been successfully booked. Get ready for an amazing journey!
            </p>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-4 text-blue-100">
                    <span className="flex items-center gap-1">
                      ...
                      {mockBookingData.passengers} Passenger
                    </span>
                    <span className="flex items-center gap-1">
                      <Plane className="h-4 w-4" />
                      {mockBookingData.flightClass} Class
                    </span>
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-3xl font-bold">${mockBookingData.totalPaid}</div>
            ...
            <div className="p-8">
              ...
              <div className="flex items-center justify-between mb-8 p-6 bg-gray-50 rounded-xl">
                <div className="text-center">
                  <div className="text-3xl font-bold text-gray-900 mb-1">06:15</div>
                  <div className="text-sm text-gray-600 font-medium">Mumbai (BOM)</div>
                  <div className="text-xs text-gray-500">Terminal 2</div>
                </div>
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-gray-900 mb-1">11:45</div>
                  <div className="text-sm text-gray-600 font-medium">Istanbul (IST)</div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <div className="text-center p-4 bg-blue-50 rounded-lg">
                  ...
                  <div className="text-blue-600 font-medium">{mockBookingData.airline}</div>
                  <div className="text-sm text-gray-600">{mockBookingData.flightNumber}</div>
                </div>
                
                <div className="text-center p-4 bg-purple-50 rounded-lg">
                  <div className="font-semibold text-gray-900">Class</div>
                  <div className="text-purple-600 font-medium">{mockBookingData.flightClass}</div>
                  <div className="text-sm text-gray-600">Premium service</div>
                </div>
                
                <div className="text-center p-4 bg-orange-50 rounded-lg">
                  <div className="font-semibold text-gray-900">Duration</div>
                  <div className="text-orange-600 font-medium">5h 30min</div>
                ...
                <div className="text-center p-4 bg-green-50 rounded-lg">
                  ...
                  <div className="text-sm text-gray-600">245 kg CO₂e</div>
                </div>
              </div>
            </div>
          </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-12">
            <Button size="lg" className="flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700">
          ...
          <Card className="shadow-xl mb-8">
            <div className="bg-gradient-to-r from-gray-800 to-gray-900 text-white p-6">
              ...
              <p className="text-gray-300">Here&apos;s what you need to do before your trip</p>
            </div>
                  ...
                  return (
                    <div key={index} className="flex items-start gap-4 p-4 rounded-lg bg-gray-50">
                      <div className={`w-12 h-12 bg-${step.color}-100 rounded-full flex items-center justify-center flex-shrink-0`}>
                        <div className={`w-6 h-6 bg-${step.color}-600 rounded-full flex items-center justify-center text-white text-xs font-bold`}>
                          {step.step}
                        </div>
                      </div>
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-sm text-gray-600">
              ...
              <span className="font-medium text-blue-600">support@emissionlab.com</span> or{" "}
