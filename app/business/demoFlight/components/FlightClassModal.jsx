  ...
  economy: {
    ...
    classic: {
      ...
      features: [
        ...
        {
          icon: RefreshCw,
          text: "Refund available before departure penalty 75 €",
          included: true,
          details: "Refund after departure unavailable",
        },
        {
          icon: RefreshCw,
          text: "Changes available before departure penalty 60 €",
          included: true,
          details: "Changes after departure unavailable",
        },
      ],
    },
    plus: {
      ...
      features: [
        ...
        {
          icon: RefreshCw,
          text: "Refund available before departure penalty 35 €",
          included: true,
          details: "Refund after departure available penalty 75 €",
        },
        {
          icon: RefreshCw,
          text: "Changes available before departure",
          included: true,
          details: "Changes available after departure penalty 50 €",
        },
      ],
    },
  },
  business: {
    budget: {
      ...
      features: [
        ...
        {
          icon: RefreshCw,
          text: "Refund available penalty 50 €",
          included: true,
        },
        {
          icon: RefreshCw,
          text: "Changes available penalty 25 €",
          included: true,
        },
      ],
    },
    classic: {
      ...
      features: [
        ...
        {
          icon: RefreshCw,
          text: "Refund available penalty 25 €",
          included: true,
        },
        {
          icon: RefreshCw,
          text: "Changes available penalty 15 €",
          included: true,
        },
      ],
    },
...
export function FlightClassModal({
  isOpen,
  onClose,
  flight,
  onSelect,
    ...
    return features.map((feature, index) => (
      <div key={index} className="flex items-start gap-3 mb-4">
        ...
        <div className="flex-1">
          ...
          {feature.details && (
            <div className="text-xs text-gray-500 mt-1">{feature.details}</div>
          )}
        </div>
      </div>
    ));
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-5xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {Object.entries(classFeatures[selectedClass]).map(
            ([subClass, details]) => (
              <Card
                key={subClass}
