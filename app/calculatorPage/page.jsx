...
const calcScopes = [
  ...
  },
  {
    ...
    desc: "Calculate your bus travel's impact.",
  },
  {
    id: 3,
    name: "Train travel",
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-[320px_1fr] gap-8 md:gap-16 mb-16 items-center">
          <div className="relative">
            <img
              src="https://res.cloudinary.com/dmazsiqdy/image/upload/f_auto,q_auto:good,w_1920/v1751543740/emisison-lab/hero-carousel/2150196640_a3fuvi.jpg"
        ...
        <div className="grid md:grid-cols-[1fr_320px] gap-8 md:gap-16 mb-16 items-center">
          ...
          <div className="relative">
            <img
              src="https://res.cloudinary.com/dmazsiqdy/image/upload/f_auto,q_auto:good,w_1920/v1751543740/emisison-lab/hero-carousel/2148997061_nmspea.jpg"
        ...
        <div className="mb-20">
          <div className="grid grid-cols-1 md:grid-cols-[320px_1fr] gap-8 md:gap-16">
            ...
            <div className="hidden md:block">
              <img
                src="https://res.cloudinary.com/dmazsiqdy/image/upload/f_auto,q_auto:good,w_1920/v1751543740/emisison-lab/hero-carousel/2151262650_sytshg.jpg"
