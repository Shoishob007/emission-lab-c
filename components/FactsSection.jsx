        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-white">
            ...
            <p className="text-xl text-green-100 mb-12 leading-relaxed">
              Our commitment to environmental excellence is reflected in the
              measurable impact we&apos;ve created across the globe through
            ...
            <div className="grid grid-cols-2 gap-8">
              {facts.map((fact, index) => (
                <div key={index} className="text-center group">
                  <div
                    className={`flex justify-center mb-4 ${fact.color} group-hover:scale-110 transition-transform duration-300`}
                  >
                    {fact.icon}
                  </div>
                  ...
                  <div className="text-green-100 text-sm">{fact.label}</div>
                </div>
              ))}
            </div>
          </div>
