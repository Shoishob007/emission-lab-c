...
const slides = [
  {
    ...
    subheading:
      "The all-in-one platform led you to a mission to drive the Earth Renewal Initiatives, restoring the balance between people, purpose, and the planet",
    primary: { text: "Learn How We Help", href: "/business" },
