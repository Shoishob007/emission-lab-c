      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Join thousands of supporters in funding critical environmental projects that make a real difference for our planet
          </p>
        </div>

        <div className="grid md:grid-cols-3 gap-8 mb-12">
          {causes.map((cause, index) => (
            <Card key={index} className="group hover:shadow-xl transition-all duration-500 hover:-translate-y-2 bg-white/90 backdrop-blur-sm border-border/50">
        ...
        <div className="text-center">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 max-w-2xl mx-auto">
            ...
            <p className="text-muted-foreground mb-6">
              Your donation directly funds verified environmental projects and helps us expand our impact worldwide. 
