    ...
    >
      <div className="relative z-10 w-full max-w-[1350px] mx-auto px-4 flex flex-col lg:flex-row items-center justify-center gap-10">
        ...
        <div className="w-full lg:w-1/2 max-w-[560px] min-w-[320px] p-4 flex flex-col justify-center">
          ...
          <p className="text-base md:text-lg text-[#767676] mb-2 leading-relaxed max-w-xl">
            We use the power of AI and machine learning to help individuals and
            businesses make data-driven, impactful climate decisions — in real
            time.
          </p>
          ...
          <div className="flex justify-center w-full">
            <Link href="/aiPage" passHref legacyBehavior>
